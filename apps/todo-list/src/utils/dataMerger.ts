 ...
 */
export async function fetchConflictingProjectsAndShowMergedResult(db: PouchDB.Database, projects: Doc<Project>[]) {
 ...
 */
export function makeDict<T>(arr: T[], fn: (item: T) => string): Record<string, T> {
...
function mergeParticipants(original: Project['participants'], incoming: Project['participants']) {
